  ...
  return (
    <div className="items-center">
      ...
      <div className="w-[50%] flex flex-row justify-between  py-5 gap-8 mx-auto">
        <Button title="on hold(5)"  buttonClass="w-[10rem] bg-gray-500 p-2 text-white rounded-xl"/>
        <Button title="Pay outs(2)"  buttonClass="w-[10rem] bg-blue-500 p-2 text-white rounded-xl"/>
        <Button title="Refund(1)"  buttonClass="w-[10rem] text-white p-2 bg-gray-500 rounded-xl"/>
      </div>
      <OrderList/>
    </div>
  );
